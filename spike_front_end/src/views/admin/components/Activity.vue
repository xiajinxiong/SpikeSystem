<template>
  <div class="user-activity">
    <el-form ref="form" :rules="rules" validate="rules" :model="form" label-width="80px">
      ...
      <ul class="list-inline">
        ...
        <li>
          <span class="link-black text-sm">
            ...
            <el-button type="danger" size="mini" @click="del(a.id)">
              点击删除
            </el-button>
          </span>
        </li>
...
import {getActivity, enter, publish, del} from "@/api/activity"
